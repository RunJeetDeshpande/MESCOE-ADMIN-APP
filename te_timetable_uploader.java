...
public class te_timetable_uploader extends AppCompatActivity {
...
//    private ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_te_timetable_uploader);
        ...
        comp1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                databaseReference = FirebaseDatabase.getInstance().getReference("TE COMP 1");
                if (pdfData == null) {
                    Toast.makeText(getApplicationContext(), "Please select pdf file", Toast.LENGTH_SHORT).show();
                } else {
                    uploadPDFfile("TE COMP 1/");
                }
            }
        ...
        comp2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                databaseReference = FirebaseDatabase.getInstance().getReference("TE COMP 2");
                if (pdfData == null) {
                    Toast.makeText(getApplicationContext(), "Please select pdf file", Toast.LENGTH_SHORT).show();
                } else {
                    uploadPDFfile("TE COMP 2/");
                }
            }
        ...
        compss.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                databaseReference = FirebaseDatabase.getInstance().getReference("TE COMP SS");
                if (pdfData == null) {
                    Toast.makeText(getApplicationContext(), "Please select pdf file", Toast.LENGTH_SHORT).show();
                } else {
                    uploadPDFfile("TE COMP SS/");
                }
            }
